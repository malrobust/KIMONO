...
from kimono.fuzzer import run_fuzz_test, INJECTION_PAYLOADS
...
def test_fuzzer_against_guarded_agent():
    ...
    def guarded_decide_fn(prompt: str):
        ...
        if "shell" in prompt_lower or "exec" in prompt_lower or "passwd" in prompt_lower:
            action_type = "shell_exec"
        elif "credential" in prompt_lower or "api_key" in prompt_lower or "mandatory" in prompt_lower:
