...
class LangGraphAgentGuardAdapter:
    ...
    def sync_state(self, messages: List[Any]) -> List[str]:
        ...
        for idx, msg in enumerate(messages):
            ...
            msg_id = getattr(msg, "id", None) or (isinstance(msg, dict) and msg.get("id"))
            if not msg_id:
    ...
    def check_tool_call(self, tool_name: str, tool_args: Any, messages: List[Any]) -> Decision:
        """
...
def guard_tool(guard: AgentGuard):
    """
